...
public class Main {
	...
	// write your code here
        System.out.println("hello Kirrishz");
    }
}
public class Main {

    static String name = "HelloKirrishz";
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        com.unijava.Vehicle vehicle = new com.unijava.Vehicle("EP CAE 4455");
        vehicle.setLicenseNumber("SP CAA 1122");

        System.out.println("License Number: " + vehicle.getLicenseNumber());


        com.unijava.Car car = new com.unijava.Car();
        ...
        com.unijava.Bike bike = new com.unijava.Bike();
        bike.run();

        com.unijava.Vehicle myCar = new com.unijava.Car();
        myCar.run();
